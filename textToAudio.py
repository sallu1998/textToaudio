...
# imageicon=PhotoImage(file="abc.png")
# btn=Button(root,text="Speak",compound=LEFT,image=imageicon,width=10,font="arial 14 bold")

btn=Button(root,text="Speak",width=10,font="arial 14 bold",command=speaknow)
btn.place(x=550,y=280)

save=Button(root,text="Save",width=10,font="arial 14 bold",command=download)
